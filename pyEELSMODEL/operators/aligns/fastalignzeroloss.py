...
class FastAlignZeroLoss(Align):
    """
    FastAlignZeroLoss is a class which aligns the zero loss peak and other spectra can be
    added which also need to be aligned. It calculates the maximum value of the spectrum.
    ...
    """
    def __init__(self, multispectrum, other_spectra=None, signal_range=None, cropping=True):
        super().__init__(multispectrum, other_spectra, cropping, signal_range, zero_index=0)
